...
-(void)initJoystickAndButtons {
    ...
    fireButtonPosition = ccp(screenSize.width-32.0f, 64.0f);
    
    jumpButtonPosition = ccp(screenSize.width-64.0f, 32.0f);
    //    }
    ...
    SneakyButtonSkinnedBase *fireButtonBase = [[[SneakyButtonSkinnedBase alloc] init] autorelease];
    
    fireButtonBase.position = fireButtonPosition;
    
    fireButtonBase.defaultSprite = [CCSprite spriteWithFile:@"fire_button4_64x64.png"];
    
    fireButtonBase.activatedSprite =
    [CCSprite spriteWithFile:@"fire_button4_64x64.png"];
    
    fireButtonBase.pressSprite =
    [CCSprite spriteWithFile:@"button_pressed1_64x64.png"];
    
    fireButtonBase.button = [[SneakyButton alloc]initWithRect:fireButtonDimensions];
    
    fireButton = [fireButtonBase.button retain];
    
    fireButton.isToggleable = NO;
    ...
    jumpButtonBase.defaultSprite = [CCSprite spriteWithFile:@"jump_button1_64x64.png"];
    
    jumpButtonBase.activatedSprite =
    [CCSprite spriteWithFile:@"jump_button1_64x64.png"];
